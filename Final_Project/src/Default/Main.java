...
public class Main {
    ...
    public static ArrayList<typeOfCause> chooseCauses() throws Exception {
        ...
        ArrayList<typeOfCause> res = new ArrayList<typeOfCause>();
    ...
    public static void main(String[] sa) {
        ...
        House h;
        Room r;
        String in0, in1, in2, in3;
        Sensor s;
        ArrayList<typeOfCause> cs;
            ...
            try {
                ...
                case 1: // add onject
                    ...
                    switch (o) {
                        ...
                        h = chooseHouse(cmp);
                        r = chooseRoom(h);
                        o = choose("EMERGENCY LEVEL", new String[] {"1", "2", "3", "4", "4"});
                        cs = chooseCauses();
