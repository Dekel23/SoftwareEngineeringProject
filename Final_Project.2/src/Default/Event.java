...
public class Event {
    ...
    private HashSet<typeOfCause> cause; // List of what happend
    ...
    public Event(String information) throws Exception 
    {
        ...
        HashSet<typeOfCause> causes = new HashSet<typeOfCause>();
    ...
    public Event(Event other)
    {
        ...
        this.cause = new HashSet<>(other.getCause());
    }

    // constructor
    public Event(int Lvl, HashSet<typeOfCause> causes, Date time) throws Exception
    {
    ...
    public HashSet<typeOfCause> getCause() {return cause;}
    public void setCause(HashSet<typeOfCause> causes) {this.cause = new HashSet<>(causes);}
